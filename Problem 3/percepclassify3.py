...
inputFile = open('/Users/abel/Desktop/NLP/Problem 3/corpus/dev-text.txt', 'r')
input = [i.strip().split() for i in inputFile.readlines()]

# ModelFile= open(sys.argv[1], 'r')
ModelFile = open('/Users/abel/Desktop/NLP/Problem 3/vanillamodel.txt')
...
for review in input:
    ...
    if pn >= 0:
        ...
        output = output + 'Neg\n'
OutputFile = open('/Users/abel/Desktop/NLP/Problem 3/percepoutput.txt', 'w')
